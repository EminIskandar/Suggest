...
import getAllSuggestCount from 'helpers/getAllSuggestCount'
import { 
...
export default function Index() {
    ...
    const countSuggests = getAllSuggestCount()
        ...
        <Container>
            <Left>
                <Suggest>
                    ...
                    <Count>{countSuggests} Suggestions</Count>
                </Suggest>
                <Short>
